...
![build success](../campaign3/pictures/Deployment.png)
...
Testnet Deployment was Built Successful!![Testnet success](../campaign3/pictures/testnetSuccess.png)

## Deployment of the dApp Frontend.

Finally, I managed to deploy the frontend dApp,Had it running in `localhost:3000` ![Frontend Running](../campaign3/pictures/frontendport.png)
The frontend was Deployed successful showing the `preimage` &`hash` that was generated.![Frontend Running](../campaign3/pictures/frontend.png)
